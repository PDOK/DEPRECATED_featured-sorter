...
(defn create-schema [db schemaname]
  (log/info (str "creating schema: " schemaname ))
...
(defn check-if-schema-exists [db schemaname]
  (log/info (str "check if schema exists: " schemaname ))
...
(defn drop-schema [db schemaname]
  (log/info (str "drop schema: " schemaname ))
...
(defn create-processing-table [db schemaname tablename]
  (log/info (str "creating table: " schemaname "." tablename))
...
(defn drop-table [db schemaname tablename]
  (log/info (str "drop table: " schemaname "."tablename))
...
(defn check-if-table-exists [db schemaname tablename]
  (log/info (str "check if table exists: " schemaname "." tablename))
